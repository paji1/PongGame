	...
	return (
		<div className={` ${!ping || ping ==="BLOCKED" ? "grayscale" : "" } flex flex-row  mx-2 gap-3 p-2 shadow-buttonShadow rounded border-solid border-textColor border-2`}>
			<div className=" w-1/6 justify-center rounded">
				<img alt="avatar" className="shadow-buttonShadow max-h-[75px] max-w-[75px] max-sm:hidden" src={friend[0].user_id.avatar}></img>
			</div>
			...
			<div className="flex flex-row items-center justify-center w-1/7 gap-x-3 ">
				<svg onClick={() => inviteToGame(socket,friend[0].user_id, EDifficulty.EASY,navigate )} className="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<rect x="16" y="12" width="2" height="2" rx="1" fill="#24BEC8" />
					<path
				...
				<svg onClick={() => inviteToGame(socket,friend[0].user_id, EDifficulty.MEDIUM,navigate)} className="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<rect x="16" y="12" width="2" height="2" rx="1" fill="#0076C0" />
					<path
						d="M14 8V8C14 7.58326 14 7.37488 13.9655 7.19144C13.8455 6.5546 13.4245 6.01534 12.8358 5.74455C12.6662 5.66654 12.464 5.616 12.0597 5.51493L12 5.5C11.5388 5.3847 11.3082 5.32706 11.1171 5.233C10.5686 4.96315 10.1737 4.45731 10.0449 3.85979C10 3.65151 10 3.41382 10 2.93845V2"
						stroke="#0076C0"
						strokeWidth="5"
				...
				<svg onClick={() => inviteToGame(socket,friend[0].user_id , EDifficulty.HARD,navigate)} className="cursor-pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<rect x="16" y="12" width="2" height="2" rx="1" fill="#F18DB3" />
					<path
						d="M14 8V8C14 7.58326 14 7.37488 13.9655 7.19144C13.8455 6.5546 13.4245 6.01534 12.8358 5.74455C12.6662 5.66654 12.464 5.616 12.0597 5.51493L12 5.5C11.5388 5.3847 11.3082 5.32706 11.1171 5.233C10.5686 4.96315 10.1737 4.45731 10.0449 3.85979C10 3.65151 10 3.41382 10 2.93845V2"
						stroke="#F18DB3"
						strokeWidth="5"
